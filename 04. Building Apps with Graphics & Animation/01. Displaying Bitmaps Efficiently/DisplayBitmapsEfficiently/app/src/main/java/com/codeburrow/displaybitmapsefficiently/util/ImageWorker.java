package com.codeburrow.displaybitmapsefficiently.util;
...
/**
 * This class wraps up completing some arbitrary long running work when loading a bitmap to an ImageView.
 * It handles things like using a memory and disk cache,
...
public abstract class ImageWorker {
    ...
    public void loadImage(Object data, ImageView imageView, OnImageLoadedListener listener) {
        ...
        if (value != null) {
            ...
            /* NOTE:
             *      This uses a custom version of AsyncTask that has been pulled from the
             *      framework and slightly modified.
    ...
    public static void cancelWork(ImageView imageView) {
        ...
        if (bitmapWorkerTask != null) {
            ...
            if (BuildConfig.DEBUG) {
                ...
                Log.e(LOG_TAG, "cancelWork - cancelled work for " + bitmapData);
            }
        }
    }
    ...
    public static boolean cancelPotentialWork(Object data, ImageView imageView) {
        ...
        if (bitmapWorkerTask != null) {
            ...
            if (bitmapData == null || !bitmapData.equals(data)) {
                bitmapWorkerTask.cancel(true);
                if (BuildConfig.DEBUG) {
                    Log.e(LOG_TAG, "cancelPotentialWork - cancelled work for " + data);
                }
            } else {
    ...
    private class BitmapWorkerTask extends AsyncTask<Void, Void, BitmapDrawable> {
        ...
        protected BitmapDrawable doInBackground(Void... params) {
            ...
            if (BuildConfig.DEBUG) {
                Log.e(LOG_TAG, "doInBackground - starting work");
            }
            ...
            if (BuildConfig.DEBUG) {
                Log.e(LOG_TAG, "doInBackground - finished work");
            }
        ...
        protected void onPostExecute(BitmapDrawable value) {
            ...
            if (value != null && imageView != null) {
                if (BuildConfig.DEBUG) {
                    Log.e(LOG_TAG, "onPostExecute - setting bitmap");
                }
                success = true;
