package com.codeburrow.display_bitmaps_efficiently_demo_4.util;
 ...
 * Use {@link ImageCache#getInstance(android.support.v4.app.FragmentManager, ImageCacheParams)}
...
public class ImageCache {
    ...
    private void init(ImageCacheParams cacheParams) {
        ...
        if (mCacheParams.memoryCacheEnabled) {
            if (BuildConfig.DEBUG) {
                Log.e(LOG_TAG, "Memory cache created (size = " + mCacheParams.memCacheSize + ")");
            }
                ...
                if (mCacheParams.diskCacheEnabled && diskCacheDir != null) {
                    ...
                    if (getUsableSpace(diskCacheDir) > mCacheParams.diskCacheSize) {
                        try {
                            ...
                            if (BuildConfig.DEBUG) {
                                Log.e(LOG_TAG, "Disk cache initialized");
                            }
    ...
    public BitmapDrawable getBitmapFromMemCache(String data) {
        ...
        if (BuildConfig.DEBUG && memValue != null) {
            Log.e(LOG_TAG, "Memory cache hit");
        }
    ...
    public void clearCache() {
        if (mMemoryCache != null) {
            ...
            if (BuildConfig.DEBUG) {
                Log.e(LOG_TAG, "Memory cache cleared");
            }
        }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null && !mDiskLruCache.isClosed()) {
                try {
                    ...
                    if (BuildConfig.DEBUG) {
                        Log.e(LOG_TAG, "Disk cache cleared");
                    }
                } catch (IOException e) {
        ...
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache != null) {
                try {
                    mDiskLruCache.flush();
                    if (BuildConfig.DEBUG) {
                        Log.e(LOG_TAG, "Disk cache flushed");
                    }
                } catch (IOException e) {
            ...
            if (mDiskLruCache != null) {
                try {
                    if (!mDiskLruCache.isClosed()) {
                        ...
                        mDiskLruCache = null;
                        if (BuildConfig.DEBUG) {
                            Log.e(LOG_TAG, "Disk cache closed");
                        }
                    }
                } catch (IOException e) {
