...
public class CrossfadeActivity extends Activity {
    ...
    // The flag indicating whether content is loaded (text is shown) or not (loading spinner ia shown).
