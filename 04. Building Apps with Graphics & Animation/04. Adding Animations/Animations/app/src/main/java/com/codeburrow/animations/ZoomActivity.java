...
public class ZoomActivity extends Activity {
    ...
    private void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        // Adjust the start bounds to be the same aspect ratio
        // as the final bounds using the "center crop" technique.
        ...
        // Set the pivot point for SCALE_X and SCALE_Y transformations to the top-left
        // corner of the zoomed-in view (the default is the center of the view).
        ...
        // Upon clicking the zoomed-in image,
        // it should zoom back down to the original bounds
