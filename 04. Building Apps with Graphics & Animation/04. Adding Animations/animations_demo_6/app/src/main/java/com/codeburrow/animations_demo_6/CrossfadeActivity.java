...
package com.codeburrow.animations_demo_6;
 ...
 * <p/>
 * In this sample, the two overlapping views are a loading indicator and some text content.
 * The active view is toggled by touching the toggle button in the action bar.
 * In real-world applications, this toggle would occur as soon as content was available.
 * Note that if content is immediately available,
 * a loading spinner shouldn't be presented and there should be no animation.
 */
