 ...
 * Because {@link ViewPager} automatically plays such an animation when calling {@link ViewPager#setCurrentItem(int)}, there isn't any animation-specific code in this sample.
 * <p/>
