 ...
 * by animating the bounds of the zoomed image from the thumbnail bounds to the screen bounds.
 * <p/>
 * In this sample, the user can touch one of two images.
 * Touching an image zooms it in, covering the entire activity content area.
 * Touching the zoomed-in image hides it.
 */
